# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 21:20:19 2022
...
from sklearn.metrics import make_scorer, f1_score, confusion_matrix, classification_report, roc_auc_score, accuracy_score
from sklearn.metrics import precision_recall_fscore_support as score

data = pd.read_csv(r"data\census-income-full-mixed-binarized.csv")
...
performance_df = pd.DataFrame().append({'name': 'Census Data',
