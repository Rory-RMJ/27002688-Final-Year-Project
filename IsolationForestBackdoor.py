# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 21:31:16 2022
...
from sklearn.metrics import make_scorer, f1_score, confusion_matrix, precision_score, recall_score, roc_auc_score, accuracy_score
from sklearn.metrics import precision_recall_fscore_support as score

data = pd.read_csv(r"data\UNSW_NB15_traintest_backdoor.csv") 
...
performance_df = pd.DataFrame().append({'name': 'Network Traffic Data',
